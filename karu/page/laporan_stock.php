        ...
        <div class="content-panel">
          ...
          <div class="table-responsive" style="padding-left: 10px; padding-right:10px;">
            <table class="table table-striped table-bordered table-hover" id="datatables" style="width: 100%">
              ...
              <tbody>
                <?php
                $sql = $conn->query("SELECT barang.kobar as kobar, barang.nama_barang as nama_barang, id_masuk, max(harga) as harga, SUM(sisa) as sisa FROM barang LEFT JOIN detail_barang_masuk ON barang.kobar = detail_barang_masuk.kobar GROUP BY nama_barang");
                $no = 1;
