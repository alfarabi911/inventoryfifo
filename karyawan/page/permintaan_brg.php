          ...
          <div class="row">
            <div class="col-md-12">
              <div class="alert alert-warning alert-dismissable">
                ...
                <p>1. Karyawan menginput data permintaan barang di form permintaan Barang.</p>
                <p>2. Karyawan menunggu permintaan di konfirmasi oleh Admin.</p>
                <p>3. Setelah di konfirmasi, kemudian Karyawan mencetak Form Permintaan dan kemudian membawa Form Permintaan yang telah di setujui oleh admin ke Gudang untuk dilakukan proses pengeluaran barang.</p>
                <p>4. Batas untuk Mencetak Form Permintaan Barang hanya Sehari</p>
              </div>
              <div class="col-sm-3">
            ...
            <tbody>
              <?php
              $sql = $conn->query("SELECT barang_keluar.id_keluar as id_keluar, tgl_keluar, SUM(qty) as qty FROM barang_keluar INNER JOIN detail_barang_keluar ON barang_keluar.id_keluar=detail_barang_keluar.id_keluar where SUBSTR(tgl_keluar,1,10)=DATE(NOW()) AND status='0' OR status='2' GROUP BY barang_keluar.id_keluar ORDER BY tgl_keluar DESC 
              ");
              $no = 1;
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Data Permintaan Barang <?php echo $modal['tgl_keluar']; ?></h4>
        </div>
        <div class="modal-body">
          ...
          <h5 align="center" style="color:#46b8da;"> Segera Hubungi Admin untuk Memproses Permintaan Anda! <br></h5>
          </tr>
        </div>
