...
<body onLoad="window.print()">
  <table align="center">
    ...
    <tr>
      <td align="center">
        ...
        <h4>Periode : <?php echo $_POST['from'] . ' s.d ' . $_POST['to']; ?></h4>
  ...
  <!-- tabel barang masuk -->
  <table align="center" width="62%" border="1" cellspacing="0" cellpadding="5" class="responsive table table-striped table-bordered">
    <thead>
      <tr>
        <th width="3%">
