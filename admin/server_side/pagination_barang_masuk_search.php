...
if (isset($_POST['page'])) {
  ...
  $pagConfig = array('baseURL' => 'server_side/pagination_barang_masuk_search.php', 'totalRows' => $rowCount, 'currentPage' => $start, 'perPage' => $limit, 'contentDiv' => 'posts_content');
  $pagination =  new Pagination($pagConfig);

  //get rows
  $query = $conn->query("SELECT * FROM barang_masuk WHERE id_masuk LIKE '%$keyword%' ORDER BY id_masuk DESC LIMIT $start,$limit");
      ...
      <tbody>
        <thead>
          <tr style="height: 23px;">
            ...
            <th style="width: 241px; height: 23px; text-align: center; background-color: #cff9f7;" colspan="5">ID Masuk</th>
        ...
        while ($row = $query->fetch_assoc()) { ?>
          <tr style="height: 23px;">
            ...
            <td style="width: 241px; height: 23px; text-align: center;" colspan="5"><?= $row['id_masuk'] ?></td>
          ...
          <tr style="height: 23px;">
            ...
            <th style="width: 246px; height: 23px; text-align: center;background-color: #fcf8b5;">Ket</th>
          ...
          while ($row2 = $sql2->fetch_assoc()) { ?>
            <tr style="height: 23px;">
              ...
              <td style="width: 246px; height: 23px; text-align: center;"><?= $row2['rak'] ?></td>
              <td style="width: 246px; height: 23px; text-align: center;"><?= $row2['ket'] ?></td>
