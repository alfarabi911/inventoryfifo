  ...
  <div class="col-md-12">
    ...
    <div class="content-panel">
      ...
      <div id="cari_brg_masuk">
        ...
        <div id="posts_content" style="padding-left: 10px; padding-right: 10px;">
          <?php
              ...
              <tbody>
                ...
                <thead>
                  <tr style="height: 23px;">
                    ...
                    <th style="width: 246px; height: 23px; text-align: center; background-color: #cff9f7;" colspan="2">Option</th>
                  </tr>
                </thead>
                ...
                while ($row = $query->fetch_assoc()) { ?>
                  <tr style="height: 23px;">
                    ...
                    <td style="width: 246px; height: 23px; text-align: center;" colspan="2">
